...
# Generated on: Thu May 14 14:15:07 IST 2026 (Thu May 14 08:45:07 GMT 2026)

tcl_set_command_name_echo on

set_log_file fv/std_mult/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/std_mult -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/multiplier/std_mult.sv
elaborate_design -golden -root {std_mult} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/std_mult/fv_map.v.gz
elaborate_design -revised -root {std_mult}
