...
# Generated on: Thu May 14 14:24:50 IST 2026 (Thu May 14 08:54:50 GMT 2026)

tcl_set_command_name_echo on

set_log_file fv/cim_array/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/cim_array -revised fv_map
...
elaborate_design -golden -root {cim_array} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cim_array/fv_map.v.gz
elaborate_design -revised -root {cim_array}
...
#add_name_alias fv/cim_array/fv_map.singlebit.original_name.alias.json.gz -revised
