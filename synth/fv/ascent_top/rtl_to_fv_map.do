...
# Generated on: Thu May 14 16:33:31 IST 2026 (Thu May 14 11:03:31 GMT 2026)

tcl_set_command_name_echo on

set_log_file fv/ascent_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ascent_top -revised fv_map
...
add_search_path /home/EIvlsi3/Digital/lib -library -both
read_library -liberty -both   /home/EIvlsi3/Digital/lib/typical.lib
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/multiplier/loa_mult.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/cim_array/cim_row.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/cim_array/cim_array.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/controller/sparse_ctrl_dense.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/top/uart_tx.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/top/uart_rx.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/top/ascent_top.sv
elaborate_design -golden -root {ascent_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ascent_top/fv_map.v.gz
elaborate_design -revised -root {ascent_top}
...
#add_name_alias fv/ascent_top/fv_map.singlebit.original_name.alias.json.gz -revised
