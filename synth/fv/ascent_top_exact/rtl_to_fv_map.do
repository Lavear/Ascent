...
# Generated on: Thu May 14 16:17:39 IST 2026 (Thu May 14 10:47:39 GMT 2026)

tcl_set_command_name_echo on

set_log_file fv/ascent_top_exact/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ascent_top_exact -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/cim_array/cim_row_exact.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/cim_array/cim_array_exact.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
...
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -systemverilog ../rtl/top/ascent_top_exact.sv
elaborate_design -golden -root {ascent_top_exact} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ascent_top_exact/fv_map.v.gz
elaborate_design -revised -root {ascent_top_exact}
...
#add_name_alias fv/ascent_top_exact/fv_map.singlebit.original_name.alias.json.gz -revised
